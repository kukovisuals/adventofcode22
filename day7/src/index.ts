...
async function partOne(inputFile: string) {
  ...
  let rootDirectory = main(terminalOutputLines)
...
function main(terminalOutputLines: (Command | FileSystemNode)[]) {
